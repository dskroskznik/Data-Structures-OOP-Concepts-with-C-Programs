/* Object Oriented Coding Content: Class Structure, Inheritance, Methodizing, Polymorphism
Classes
    Members
    Methods
...
public:
    // Initializer list
    Animal(int _height = 0, int weight = 0, std::string name = "Default") : height(_height), weight(weight), name(name) { count++; }
